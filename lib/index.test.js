...
describe("complex example", () => {
  ...
  it("should pass through HTML unescaped when escape option is false", () => {
    const htmlInput = "Lorem ipsum {==<em>dolor sit amet</em>==}";
    const expectedOutput = "Lorem ipsum <mark><em>dolor sit amet</em></mark>";

    const renderedInput = render(htmlInput, { escape: false });
    assert.strictEqual(renderedInput, expectedOutput);
  });
});
